...
class FlexCards {
    ...
    constructor(element) {
        ...
        this.timeElapsed = 0;
        /** @var getElapsed */
        this.getElapsed = setInterval(() => void 0, this.delay);
    ...
    mount({ component = "default", indexType = "points", theme = "#666", timer = false, }) {
        ...
        // Create components
        let container = createElement('div'), content = createElement('div'), index = createElement('div'), arrow_a = createElement('button'), arrow_b = createElement('button'), image_a = createElement('img'), image_b = createElement('img'), timerDisplay = createElement('span');
        // Add classes
    ...
    carousel(params) {
        ...
        function onScroll() {
            ...
            // Change slide if >= 5%
            if (calc >= 5)
                components.arrows.right.click();
            else if (calc <= -5)
                components.arrows.left.click();
        }
        // Render function
        function render(step = 0) {
            ...
            const updateContent = () => {
                ...
                if (components.timer)
                    components.timer.style.setProperty('--percentage', '0');
            };
